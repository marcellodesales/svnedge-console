pkg = {
    ...
    "files" : {
        ...
        "bin/csvn" : {"mode" : "0755", "os" : "solaris"},
        "bin/csvn-httpd" : {"mode" : "0755", "os" : "solaris"},
        ...
        "bin/start.ini" : {"mode" : "0755", "os" : "solaris"},
        ...
        "lib/wrapper.jar" : {"mode" : "0755", "os" : "solaris"},
    },
    
    "dirtrees" : {
        "appserver"       : {"mode" : "0755", "os" : "unix"},
        "appserver"       : {"mode" : "0755", "os" : "solaris"},
