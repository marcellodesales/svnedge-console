...
class UploadStatJob {
    ...
    // concurrent calls to the Master.
    def concurrent = false

    static triggers = { 
    /*
        simple name: "uploadStatTrigger", group: group + "_Triggers", \
        startDelay: 6550, \
        repeatInterval: \
            ConfigurationHolder.config.svnedge.replica.stat.uploadRate * 60000
    */
    }

    def execute() {
        log.info("Executing UploadStatJob")
