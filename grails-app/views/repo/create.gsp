      ...
      new Ajax.Request('/csvn/repo/dumpFileListAll', {
                ...
                onSuccess: function(transport) {
                  ...
                  if (responseJson.result != null) {
                    ...
                    for (var key in responseJson.result.repoDumps) {
                      ...
                      if (backups.length > 0) {
                        ...
                        for (i = 0; i < backups.length; i++) {
                          backupsHtml += "<li class='backup'>" + backups[i]
                        }
                        backupsHtml += "</ul>"
                      }
                    ...
                    $('backupChooser').innerHTML = backupsHtml;
...
<g:form action="save" method="post">
  ...
  <tr class="prop">
    ...
    <td valign="top" class="value ${hasErrors(bean: repo, field: 'useBackup', 'errors')}">
      <g:radio name="initOption" value="useTemplate" id="useTemplate" class="repoInitOptions" checked="true"/><label
